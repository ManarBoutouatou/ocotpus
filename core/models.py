...
class Service(models.Model):
    ...
    category = models.ForeignKey(Category, verbose_name=_("DAS categorie"), on_delete=models.CASCADE,blank=True, null=True)
    description = tinymce_models.HTMLField(verbose_name='Déscription du produit', blank=True, null=True)
...
class Article(models.Model):
    ...
    slug = models.SlugField()
    aperçu   = models.CharField( max_length=300, verbose_name='aperçu')
    texte   = tinymce_models.HTMLField(verbose_name='Déscription du produit', blank=True, null=True)
